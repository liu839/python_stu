...
file_name = r'D:\liu\python_stu\程序记录\tk\student.txt'
# flag = True
# while flag:
...
def save():
    with open(file_name, 'w') as f:
        for each in students:
            f.writelines('{} {} {} {}\n'.format(
                each.number, each.name, each.score_1, each.score_2))
...
e6 = Entry(master, textvariable=number_show).grid(
